        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Supplier Documents</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
                            ...
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="card-title"><span id="filter">| Supplier Documents</span></h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-document', function() {
                ...
                $.get("{{ route('supplier_docs.get', '') }}/" + id, function(data) {
            ...
            $(document).on('click', '.delete-document', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('supplier_docs/delete') }}/' + id,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
